...
export const BRAND_SCENE_MANDATES: Record<string, string> = {
  Roosterbet:  'FIRE IS MANDATORY AND MUST ORIGINATE FROM THE MAIN SUBJECT: Keep the EXACT hero subject described in the base scene as a solid, real, fully-formed photorealistic figure or object — its identity, true surface, material and details sharp, unmistakable and dominant in the frame. The flames cling to and trace the subject\'s own surface, feathers/skin/fabric and edges, hugging its silhouette like a glowing fiery aura that stays attached to the subject, with warm red/crimson/orange light in the surroundings. The fire is part of the subject itself; describe it only once and keep the subject the clear focus. This is the Roosterbet signature.',
