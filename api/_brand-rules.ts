export const BRAND_PALETTES: Record<string, string> = {
  ...
  Roosterbet:  'Red, crimson, fiery orange, black, bold white. High-energy, bold, high-contrast palette. NEVER use pastel, soft pink, or muted tones.',
...
export const BRAND_SCENE_MANDATES: Record<string, string> = {
  Roosterbet:  'FIRE IS MANDATORY AND MUST ORIGINATE FROM THE MAIN SUBJECT: Keep the EXACT hero subject described in the base scene as a solid, real, fully-formed photorealistic figure or object — its identity, true surface, material and details sharp, unmistakable and dominant in the frame. The flames trace and outline the subject\'s edges, feathers/skin/fabric and silhouette as a controlled glowing fiery rim attached to the subject, with glowing embers and bright sparks drifting through the surrounding air and warm red/crimson/orange light in the scene. The fire stays part of the subject itself; describe it only once and keep the subject the clear focus. This is the Roosterbet signature.',
