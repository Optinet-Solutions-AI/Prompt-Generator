...
// so to honour an exact request like 1200×600 we cover-crop + resize the
// generated bytes BEFORE saving to Drive. This makes the stored/preview
// image itself the exact size — not just the download. Uses sharp (already
