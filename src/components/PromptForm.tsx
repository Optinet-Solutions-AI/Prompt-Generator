...
import { Archive, ClipboardPaste, Heart, Loader2, Pencil, Sparkles, Trash2 } from "lucide-react";
    ...
    >
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          {/* Reference actions — these all act on an already-chosen brand or
              reference, so they stay muted and tucked under the dropdown. */}
          {formData.brand && (
